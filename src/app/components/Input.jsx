...
export const Input = () => {
  ...
  return (
    <div className=' flex flex-col w-full lg:w-1/3 space-y-2 m-auto lg:min-w-fit'>
      ...
      {isOnEdit ? <div className=' flex justify-between space-x-2'><button className=' w-[49%] bg-rose-300 py-2 rounded-xl hover:bg-red-400' onClick={() => updateData(id_update)}>Update</button><button className=' w-[49%] bg-rose-300 py-2 rounded-xl hover:bg-red-400' onClick={cancelEdit}>Cancel</button></div> : <button className=' bg-rose-300 py-2 rounded-xl hover:bg-red-400' onClick={addData}>Create</button>}
