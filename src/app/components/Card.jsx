...
export const Card = ({ id, content, additionalData }) => {
    const { deleteData, editData, updateData } = useContext(FlowerizeContext)
    return (
        <div className=' h-fit w-fit bg-slate-50 p-8 rounded-xl space-y-5 mb-3 lg:mb-0'>
            ...
            <div className=' flex justify-between'>
                ...
                <div className=' flex justify-between space-x-2'>
                    <Pencil className=' hover:text-rose-400' onClick={() => editData(id, {content: content, additionalData: additionalData})} />
